...
//        //Expression 4
        ...
        System.out.println((1.0) - 8 + 8.0 / 8.0 + (Math.sqrt(81) / 3));
        System.out.println((1.0) - 8.0 + 8.0 / 8.0 + 9.0 / 3);
        System.out.println((1.0) - 8.0 + 1.0 + 9.0 / 3);
        System.out.println(1.0 - 8.0 + 1.0 + 3.0);
        System.out.println(-7.0 + 1.0 + 3.0);
